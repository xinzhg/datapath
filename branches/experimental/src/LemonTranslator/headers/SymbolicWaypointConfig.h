...
public:
	...
	void SetDoubleParam(string name, double value);

	/* Sets the value of a string parameter */
	void SetStringParam(string name, string value);

	/* Sets the value of a query specific string parameter */
	void SetStringParam(QueryID query, string name, string value);
	...
	string GetStringParam(QueryID query, string name);
...
inline void SymbolicWaypointConfig::SetIntParam(string name, int value) {
	intParams[name] = value;
}

inline void SymbolicWaypointConfig::SetDoubleParam(string name, double value) {
	doubleParams[name] = value;
}

inline void SymbolicWaypointConfig::SetStringParam(string name, string value) {
	stringParams[name] = value;
}

inline void SymbolicWaypointConfig::SetStringParam(QueryID query, string name, string value){
