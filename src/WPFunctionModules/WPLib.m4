...
dnl # extract the initializer from $1
m4_define(</_GLA_INITIALIZER/>, </dnl
<//>m4_seventh(</$1/>)<//>dnl
/>)dnl
...
dnl # extract the initializer from $1
m4_define(</GLA_INIT_STATE/>, </dnl
<//>m4_fourth(</$1/>)<//>dnl
/>)dnl

dnl # form the name of the variable that has the GLA state based on query description.
m4_define(</GLA_EXPRESSION/>, </dnl
<//>m4_sixth(</$1/>)<//>dnl
/>)dnl


dnl # form the name of the variable that has the GLA state based on query description.
m4_define(</GLA_TYPE/>, </dnl
<//>m4_second(</$1/>)<//>dnl
/>)dnl

dnl # kind of GLA (single, multi, state)
m4_define(</GLA_KIND/>, </dnl
<//>reval(GLA_REZTYPE_<//>GLA_TYPE(</$1/>))<//>dnl
/>)dnl
...
m4_define(</GLA_CONST_STATES/>, </dnl
<//>reval(GLA_TYPE(</$1/>)</_CONST_STATE/>)<//>dnl
/>)dnl

dnl # the list of const states that should be generated by the waypoint
m4_define(</GLA_CONST_GENERATED/>, </dnl
<//>reval(GLA_TYPE(</$1/>)</_CONST_GEN/>)<//>dnl
/>)dnl

dnl # the list of const states that are received from other waypoints
m4_define(</GLA_CONST_RECEIVE/>, </dnl
<//>reval(GLA_TYPE(</$1/>)</_CONST_REC/>)<//>dnl
/>)dnl
...
dnl # form the name of the variable that has the GLA state based on query description.
m4_define(</GLA_STATE/>, </dnl
<//>GLA_TYPE(</$1/>)_<//>M4_QUERY_NAME(</$1/>)<//>dnl
/>)dnl
