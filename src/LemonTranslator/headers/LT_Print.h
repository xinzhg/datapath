...
public:
    ...
    virtual bool AddPrint(QueryID query, SlotSet& atts, string expr, string initializer, string header="", string file="", string defs = "", string separator=",");
