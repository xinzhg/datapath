...
private:
  //constructor
  NetworkConfigurationMessage(string _parent, vector<string> _children ):
  ...
  //constructor with the extra parameter typeIndicator
  NetworkConfigurationMessage(string _parent, vector<string> _children, bool _typeIndicator ) : // copy constructed members
...
public:
 ...
 ; else return RemoteMessage::Type();}
  ...
  // friend declarations
  friend void NetworkConfigurationMessage_Factory(EventProcessor& dest ,string _parent, vector<string> _children);
...
inline void NetworkConfigurationMessage_Factory(EventProcessor& dest ,string _parent, vector<string> _children){
