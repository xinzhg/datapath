...
m4_define(</_PRINT_INITIALIZER/>, </dnl
<//>m4_third(</$1/>)<//>dnl
/>)<//>dnl
...
dnl # Macro to determine if a DataType requires a dictionary
dnl # $1 = The attribute type
m4_define(</_TYPE_REQ_DICT/>, </dnl
<//>m4_ifdef(</$1_DICT/>, </1/>, </0/>)<//>dnl
/>)<//>dnl

dnl # Macro to return the name of the dictionary for a type.
dnl # $1 = the attribute type
m4_define(</_TYPE_DICT/>, </dnl
<//>m4_quote($1_DICT)<//>dnl
/>)<//>dnl
