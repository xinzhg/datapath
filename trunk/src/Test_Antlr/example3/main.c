...
//
#include<iostream>
// Both below STL headers need to be included here before Eval.h, otherwise compiler will complain
// since both are included inside extern C statement in Eval.h which is not good.
#include<map>
#include<string>
#include "TLexer.h"
#include "Eval.h"
...
main	(int argc, char *argv[])
{
    ...
    //
    lxr	    = TLexerNew(input);	    // TLexerNew is generated by ANTLR
    ...
    //
    psr	    = TParserNew(tstream);  // CParserNew is generated by ANTLR3
