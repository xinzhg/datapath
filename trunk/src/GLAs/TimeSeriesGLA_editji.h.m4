...
/*
	comments Joost: I think this needs a struct as in TopKGLA
	=> A vector of structs, where each struct holds
	     - firm identifier (cusip/ticker)
	     - a map with the timestructure

	code-generate the desired granularity (instead of computing all of them)
*/
