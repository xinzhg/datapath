...
dnl
m4_redefine(</MY_INPUT/>, m4_quote(GLUE_LISTS(</SEG_KEY/>, INNER_GLA</_INPUT/>)))dnl
m4_redefine(</MY_OUTPUT/>, m4_defn(INNER_GLA</_OUTPUT/>))dnl
m4_ifdef(INNER_GLA</_INIT/>, </dnl
<//>m4_redefine(</MY_INIT/>, m4_defn(INNER_GLA</_INIT/>))<//>dnl
/>, </dnl
<//>m4_redefine(</MY_INIT/>, <//>)<//>dnl
/>)dnl
m4_redefine(</INNER_INPUT/>, m4_defn(INNER_GLA</_INPUT/>))dnl
m4_redefine(</INNER_OUTPUT/>, m4_defn(INNER_GLA</_OUTPUT/>))dnl
