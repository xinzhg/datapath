...
public:
	...
	virtual bool AddSynthesized(QueryID query, SlotID att, SlotSet& atts,
															string expr, string initializer) {
		return false;
	}
	...
	virtual bool AddPrint(QueryID query, SlotSet& atts, string expr /* what to print */, string initializer, string name="", string type="", string file=""){
		return false;
	}
