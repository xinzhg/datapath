...
public:
	...
	ScannerConfig(string _relation, QueryExitContainer& _queryExits, QueryExitContainer& _qExitsDone,
								SlotToSlotMap& _columnsToSlotsMap, QueryExitToSlotsMap& _queryColumnsMap);
	
	
	void GetData(string& _relation, QueryExitContainer& _queryExits, 
...
inline 	ScannerConfig::ScannerConfig(string _relation, QueryExitContainer& _queryExits, 
																		 QueryExitContainer& _qExitsDone,
																		 SlotToSlotMap& _columnsToSlotsMap, 
																		 QueryExitToSlotsMap& _queryColumnsMap)
	:relation(_relation){
...
inline void ScannerConfig::GetData(string& _relation, QueryExitContainer& _queryExits, 
																	 QueryExitContainer& _qExitsDone,
																	 SlotToSlotMap& _columnsToSlotsMap, 
																	 QueryExitToSlotsMap& _queryColumnsMap){
